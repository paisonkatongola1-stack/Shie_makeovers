...
const Footer = () => {
  return (
    <footer className="bg-white pt-16 pb-8 border-t border-accent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="text-2xl font-serif font-bold tracking-tight text-foreground">
              SHIE <span className="text-secondary font-light italic">MakeOvers</span>
            </Link>
            <p className="mt-4 text-foreground/60 font-sans text-sm leading-relaxed">
              Beautiful Nails. Professional Care. Experience the ultimate in beauty artistry and luxury treatments at Shie MakeOvers.
            </p>
            <div className="flex space-x-4 mt-6">
              <Link href="#" className="text-secondary/60 hover:text-secondary transition-colors">
                <Camera size={20} />
              </Link>
              <Link href="#" className="text-secondary/60 hover:text-secondary transition-colors">
                <Globe size={20} />
              ...
              {["Home", "Services", "Gallery", "About", "Contact", "Book"].map((item) => (
                <li key={item}>
                  <Link
                    ...
                    className="text-sm font-sans text-foreground/60 hover:text-secondary transition-colors"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-sm font-sans text-foreground/60 font-bold text-secondary">
                Phone: (555) 123-4567
              </li>
              <li className="text-sm font-sans text-foreground/60">
        ...
        <div className="border-t border-accent pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-8">
            <Link href="/privacy" className="text-[10px] font-sans font-medium uppercase tracking-widest text-foreground/40 hover:text-secondary transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-[10px] font-sans font-medium uppercase tracking-widest text-foreground/40 hover:text-secondary transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
