          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/2 space-y-10">
              ...
              <div className="space-y-6 text-lg font-sans text-foreground/70 leading-relaxed max-w-xl">
                <p>
                  Founded in 2020, Shie MakeOvers was born out of a desire to create a space where beauty meets relaxation. We believe that nail care is more than just a service&mdash;it&apos;s a form of self-expression and self-care.
                </p>
                <p>
