        ...
        return (
          <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <form className="space-y-6">
              <Input id="booking-name" label="Full Name" placeholder="Jane Doe" onChange={(e) => setBookingData({...bookingData, name: e.target.value})} />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Input id="booking-email" label="Email" type="email" placeholder="jane@example.com" onChange={(e) => setBookingData({...bookingData, email: e.target.value})} />
                <Input id="booking-phone" label="Phone" type="tel" placeholder="(555) 000-0000" onChange={(e) => setBookingData({...bookingData, phone: e.target.value})} />
              </div>
              <Textarea id="booking-notes" label="Special Notes (Optional)" rows={2} placeholder="Any specific requests?" onChange={(e) => setBookingData({...bookingData, notes: e.target.value})} />
            </form>
