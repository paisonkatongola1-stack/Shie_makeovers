             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4">
                  <label
                    ...
                    className="text-[10px] font-sans font-bold uppercase tracking-[0.2em] text-foreground/40 flex items-center cursor-pointer select-none"
                  >
                  ...
                  <input
                    id="booking-date"
                    type="date"
                    className="w-full bg-white border border-accent p-6 outline-none focus:border-secondary focus:ring-1 focus:ring-secondary rounded-sm font-sans focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary"
                    onChange={(e) => setBookingData({...bookingData, date: e.target.value})}
                  />
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-sans font-bold uppercase tracking-[0.2em] text-foreground/40 flex items-center select-none">
                    <ClockIcon size={14} className="mr-2" /> Select Time
                  </label>
                  <div className="grid grid-cols-2 gap-3" role="group" aria-label="Select appointment time">
                    {timeSlots.map((time) => (
                      <button
                        key={time}
                        type="button"
                        ...
                        className={cn(
                          "py-4 border text-[10px] font-sans font-bold rounded-sm transition-all uppercase tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary",
