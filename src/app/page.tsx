  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-24 bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {services.map((service, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-1 group-hover:text-primary-foreground transition-colors">{service.name}</h3>
          ...
          <div className="text-center mt-16">
            <a href="/services" className="inline-block border-b-2 border-secondary pb-1 text-sm font-sans font-bold uppercase tracking-widest text-foreground hover:text-secondary transition-colors">
      ...
      <section className="py-24 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Quote className="mx-auto text-primary-foreground mb-6 opacity-30" size={48} />
      ...
      <section className="py-24 bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center">
            {[
              { icon: <UserCheck className="mx-auto text-primary-foreground mb-6" size={40} />, title: "Expert Technicians", desc: "Our staff are highly trained and experienced artists." },
              { icon: <Sparkles className="mx-auto text-primary-foreground mb-6" size={40} />, title: "Premium Products", desc: "We use only the highest quality, non-toxic products." },
              { icon: <ShieldCheck className="mx-auto text-primary-foreground mb-6" size={40} />, title: "Sterilized Tools", desc: "Your safety is our priority with medical-grade sterilization." },
              { icon: <Star className="mx-auto text-primary-foreground mb-6" size={40} />, title: "Customer Satisfaction", desc: "We strive to exceed your expectations every time." },
            ].map((feature, idx) => (
              <div key={idx}>
                {feature.icon}
